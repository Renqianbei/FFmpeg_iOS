...
@implementation RQBPlayView
{
    
    float _decoderframeWidth  ;
    float _decoderframeHeight ;
             ...
             decoder: (KxVideoFrameFormat) Format  dW:(CGFloat)dw dH:(CGFloat)dh
{
    ...
    if (self) {
        ...
        _decoderframeWidth = dw;
        _decoderframeHeight = dh;
...
- (void)updateVertices
{
    ...
    const float width   = _decoderframeWidth;
    const float height  = _decoderframeHeight;
